...
export const en = {
	...
	cat_tyres_brakes: 'Tyres & brakes',
	cat_fluids_filters: 'Fluids & filters',
	cat_engine: 'Engine & drivetrain',
	cat_service: 'Checks & service',
	tmpl_oil_filter: 'Oil & filter change',
	tmpl_tyres_seasonal: 'Seasonal tyre change',
	tmpl_brake_discs: 'Brake discs',
	tmpl_fuel_filter: 'Fuel filter',
	tmpl_differential_fluid: 'Differential fluid',
	tmpl_glow_plugs: 'Glow plugs (diesel)',
	tmpl_ac_service: 'A/C service',
...
export const de: Record<TranslationKey, string> = {
	...
	cat_tyres_brakes: 'Reifen & Bremsen',
	cat_fluids_filters: 'Flüssigkeiten & Filter',
	cat_engine: 'Motor & Antrieb',
	cat_service: 'Prüfung & Service',
	tmpl_oil_filter: 'Öl- & Filterwechsel',
	tmpl_tyres_seasonal: 'Reifenwechsel (Sommer/Winter)',
	tmpl_brake_discs: 'Bremsscheiben',
	tmpl_fuel_filter: 'Kraftstofffilter',
	tmpl_differential_fluid: 'Differentialöl',
	tmpl_glow_plugs: 'Glühkerzen (Diesel)',
	tmpl_ac_service: 'Klimaanlagen-Service',
